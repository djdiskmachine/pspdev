...
#define HAVE_movsicc (ISA_HAS_CONDMOVE || ISA_HAS_SEL || ISA_HAS_INT_CONDMOVE)
#define HAVE_movdicc ((ISA_HAS_CONDMOVE || ISA_HAS_SEL || ISA_HAS_INT_CONDMOVE) && (TARGET_64BIT))
