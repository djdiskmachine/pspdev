...
enum opt_code
{
  ...
  OPT_fc_prototypes_external = 563,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 564,                    /* -fcall-saved- */
  OPT_fcall_used_ = 565,                     /* -fcall-used- */
  OPT_fcaller_saves = 566,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 567,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 568, */            /* -fcf-protection */
  OPT_fcf_protection_ = 569,                 /* -fcf-protection= */
  OPT_fchar8_t = 570,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 571,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 572, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 573,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 574,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 575,                         /* -fcheck= */
  OPT_fchecking = 576,                       /* -fchecking */
  OPT_fchecking_ = 577,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 578,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 579,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 580,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 581,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 582,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 583,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 584,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 585,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 586, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 587,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 588,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 589,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 590, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 591,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 592,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 593,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 594,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 595,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 596, */                 /* -fcilkplus */
  OPT_fcoarray_ = 597,                       /* -fcoarray= */
  OPT_fcode_hoisting = 598,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 599,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 600,                         /* -fcommon */
  OPT_fcompare_debug = 601,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 602,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 603,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 604,                   /* -fcompare-elim */
  OPT_fconcepts = 605,                       /* -fconcepts */
  OPT_fcond_mismatch = 606,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 607, */           /* -fconserve-space */
  OPT_fconserve_stack = 608,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 609,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 610,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 611,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 612,           /* -fconstexpr-ops-limit= */
  ...
  OPT_fdce = 626,                            /* -fdce */
  OPT_fdebug = 627,                          /* -fdebug */
  OPT_fdebug_cpp = 628,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 629,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 630,            /* -fdebug-types-section */
  OPT_fdebug_ = 631,                         /* -fdebug= */
  OPT_fdec = 632,                            /* -fdec */
  OPT_fdec_include = 633,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 634,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 635,                       /* -fdec-math */
  OPT_fdec_static = 636,                     /* -fdec-static */
  OPT_fdec_structure = 637,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 638,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 639,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 640,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 641, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 642,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 643,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 644,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 645,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 646,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 647,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 648,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 649,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 650,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 651,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 652,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 653, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 654,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 655,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 656,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 657,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 658,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 659,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_labels = 660,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 661,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 662,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 663,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 664, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 665,                /* -fdirectives-only */
  OPT_fdisable_ = 666,                       /* -fdisable- */
  OPT_fdoc = 667,                            /* -fdoc */
  OPT_fdoc_dir_ = 668,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 669,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 670,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 671,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 672,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 673,                       /* -fdruntime */
  OPT_fdse = 674,                            /* -fdse */
  OPT_fdump_ = 675,                          /* -fdump- */
  OPT_fdump_ada_spec = 676,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 677,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 678, */                /* -fdump-core */
  OPT_fdump_d_original = 679,                /* -fdump-d-original */
  OPT_fdump_final_insns = 680,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 681,              /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 682,            /* -fdump-fortran-global */
  ...
  OPT_fgo_dump_ = 759,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 760,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 761,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 762,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 763,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 764,                       /* -fgraphite */
  OPT_fgraphite_identity = 765,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 766,       /* -fguess-branch-probability */
  OPT_fguiding_decls = 767,                  /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 768, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 769, */                     /* -fhelp */
  ...
  OPT_fignore_unknown_pragmas = 778,         /* -fignore-unknown-pragmas */
  ...
  OPT_findirect_inlining = 783,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 784,         /* -finhibit-size-directive */
  OPT_finit_character_ = 785,                /* -finit-character= */
  OPT_finit_derived = 786,                   /* -finit-derived */
  OPT_finit_integer_ = 787,                  /* -finit-integer= */
  OPT_finit_local_zero = 788,                /* -finit-local-zero */
  OPT_finit_logical_ = 789,                  /* -finit-logical= */
  OPT_finit_real_ = 790,                     /* -finit-real= */
  OPT_finline = 791,                         /* -finline */
  OPT_finline_atomics = 792,                 /* -finline-atomics */
  OPT_finline_functions = 793,               /* -finline-functions */
  OPT_finline_functions_called_once = 794,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 795, */            /* -finline-limit- */
  OPT_finline_limit_ = 796,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 797,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 798,         /* -finline-small-functions */
  OPT_finput_charset_ = 799,                 /* -finput-charset= */
  OPT_finstrument_functions = 800,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 801,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 802,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 803,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 804,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 805,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 806,                     /* -finvariants */
  OPT_fipa_bit_cp = 807,                     /* -fipa-bit-cp */
  ...
  OPT_fipa_reference_addressable = 820,      /* -fipa-reference-addressable */
  OPT_fipa_sra = 821,                        /* -fipa-sra */
  OPT_fipa_stack_alignment = 822,            /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 823, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 824,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 825,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 826,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 827,              /* -fira-loop-pressure */
  OPT_fira_region_ = 828,                    /* -fira-region= */
  OPT_fira_share_save_slots = 829,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 830,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 831,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 832,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 833,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 834,               /* -fivar-visibility= */
  OPT_fivopts = 835,                         /* -fivopts */
  OPT_fjump_tables = 836,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 837,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 838,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 839,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 840,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 841,          /* -fkeep-static-functions */
  OPT_flabels_ok = 842,                      /* -flabels-ok */
  OPT_flax_vector_conversions = 843,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 844,             /* -fleading-underscore */
  OPT_flifetime_dse = 845,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 846,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 847,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 848,                 /* -flinker-output= */
  /* OPT_flive_patching = 849, */            /* -flive-patching */
  OPT_flive_patching_ = 850,                 /* -flive-patching= */
  ...
  OPT_fmain = 872,                           /* -fmain */
  OPT_fmath_errno = 873,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 874,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 875,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 876,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 877,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 878,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 879,                     /* -fmem-report */
  OPT_fmem_report_wpa = 880,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 881,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 882,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 883,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 884,                /* -fmessage-length= */
  OPT_fmodule_file_ = 885,                   /* -fmodule-file= */
  OPT_fmodule_private = 886,                 /* -fmodule-private */
  OPT_fmoduleinfo = 887,                     /* -fmoduleinfo */
  OPT_fmodulo_sched = 888,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 889,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 890,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 891,                  /* -fms-extensions */
  OPT_fmudflap = 892,                        /* -fmudflap */
  OPT_fmudflapir = 893,                      /* -fmudflapir */
  OPT_fmudflapth = 894,                      /* -fmudflapth */
  OPT_fname_mangling_version_ = 895,         /* -fname-mangling-version- */
  OPT_fnew_abi = 896,                        /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 897,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 898,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 899,                   /* -fnext-runtime */
  OPT_fnil_receivers = 900,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 901,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 902,               /* -fnonansi-builtins */
  OPT_fnonnull_objects = 903,                /* -fnonnull-objects */
  OPT_fnothrow_opt = 904,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 905,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 906,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 907,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 908,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 909,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 910,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 911,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 912,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 913,                   /* -foffload-abi= */
  OPT_foffload_ = 914,                       /* -foffload= */
  OPT_fomit_frame_pointer = 915,             /* -fomit-frame-pointer */
  OPT_fonly_ = 916,                          /* -fonly= */
  ...
  OPT_foptimize_strlen = 926,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 927, */           /* -foptional-diags */
  OPT_fpack_derived = 928,                   /* -fpack-derived */
  OPT_fpack_struct = 929,                    /* -fpack-struct */
  OPT_fpack_struct_ = 930,                   /* -fpack-struct= */
  OPT_fpad_source = 931,                     /* -fpad-source */
  OPT_fpartial_inlining = 932,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 933,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 934,              /* -fpcc-struct-return */
  OPT_fpch_deps = 935,                       /* -fpch-deps */
  OPT_fpch_preprocess = 936,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 937,                     /* -fpeel-loops */
  OPT_fpeephole = 938,                       /* -fpeephole */
  OPT_fpeephole2 = 939,                      /* -fpeephole2 */
  OPT_fpermissive = 940,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 941,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 942,                            /* -fpic */
  OPT_fpie = 943,                            /* -fpie */
  OPT_fplan9_extensions = 944,               /* -fplan9-extensions */
  OPT_fplt = 945,                            /* -fplt */
  OPT_fplugin_arg_ = 946,                    /* -fplugin-arg- */
  OPT_fplugin_ = 947,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 948,            /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 949,                 /* -fpostconditions */
  OPT_fpre_include_ = 950,                   /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 951,             /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 952,                  /* -fpreconditions */
  OPT_fpredictive_commoning = 953,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 954,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 955,                   /* -fpreprocessed */
  OPT_fpretty_templates = 956,               /* -fpretty-templates */
  OPT_fprintf_return_value = 957,            /* -fprintf-return-value */
  OPT_fprofile = 958,                        /* -fprofile */
  OPT_fprofile_abs_path = 959,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 960,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 961,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 962,                   /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 963,         /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 964,          /* -fprofile-filter-files= */
  OPT_fprofile_generate = 965,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 966,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 967,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 968,                 /* -fprofile-report */
  OPT_fprofile_update_ = 969,                /* -fprofile-update= */
  OPT_fprofile_use = 970,                    /* -fprofile-use */
  OPT_fprofile_use_ = 971,                   /* -fprofile-use= */
  OPT_fprofile_values = 972,                 /* -fprofile-values */
  OPT_fprotect_parens = 973,                 /* -fprotect-parens */
  OPT_frandom_seed = 974,                    /* -frandom-seed */
  OPT_frandom_seed_ = 975,                   /* -frandom-seed= */
  OPT_frange_check = 976,                    /* -frange-check */
  OPT_freal_4_real_10 = 977,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 978,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 979,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 980,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 981,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 982,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 983,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 984,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 985,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 986,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 987,                /* -frecord-marker=8 */
  OPT_frecursive = 988,                      /* -frecursive */
  OPT_free = 989,                            /* -free */
  OPT_freg_struct_return = 990,              /* -freg-struct-return */
  /* OPT_fregmove = 991, */                  /* -fregmove */
  OPT_frelease = 992,                        /* -frelease */
  OPT_frename_registers = 993,               /* -frename-registers */
  OPT_freorder_blocks = 994,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 995,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 996,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 997,              /* -freorder-functions */
  OPT_frepack_arrays = 998,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 999,           /* -freplace-objc-classes */
  OPT_frepo = 1000,                          /* -frepo */
  OPT_freport_bug = 1001,                    /* -freport-bug */
  OPT_frequire_return_statement = 1002,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1003,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1004, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1005,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1006,                   /* -fresolution= */
  OPT_frounding_math = 1007,                 /* -frounding-math */
  OPT_frtti = 1008,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1009,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1010,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1011,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1012,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1013,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1014,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1015,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1016,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1017, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1018,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1019,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1020,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1021,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1022,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1023,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1024,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1025,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1026,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1027,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1028,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1029,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1030,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1031,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1032,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1033,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1034, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1035,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1036,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1037,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1038,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1039,               /* -fsection-anchors */
  /* OPT_fsee = 1040, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1041,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1042,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1043,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1044,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1045,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1046,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1047,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1048,                   /* -fshort-enums */
  OPT_fshort_wchar = 1049,                   /* -fshort-wchar */
  OPT_fshow_column = 1050,                   /* -fshow-column */
  OPT_fshrink_wrap = 1051,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1052,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1053,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1054,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1055,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1056,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1057,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1058,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1059,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1060,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1061,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1062,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1063,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1064,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1065,              /* -fsplit-wide-types */
  OPT_fsquangle = 1066,                      /* -fsquangle */
  OPT_fssa_backprop = 1067,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1068,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1069,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1070,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1071, */             /* -fstack-check */
  OPT_fstack_check_ = 1072,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1073,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1074,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1075,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1076,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1077,               /* -fstack-protector */
  OPT_fstack_protector_all = 1078,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1079,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1080,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1081,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1082,                   /* -fstack-usage */
  OPT_fstats = 1083,                         /* -fstats */
  OPT_fstdarg_opt = 1084,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1085,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1086, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1087,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1088,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1089,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1090,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1091,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1092, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1093,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1094,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1095,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1096,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1097,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1098, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1099,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1100, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1101,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1102, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1103,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1104,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1105,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1106,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1107,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1108,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1109,                   /* -ftime-report */
  OPT_ftime_report_details = 1110,           /* -ftime-report-details */
  OPT_ftls_model_ = 1111,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1112,              /* -ftoplevel-reorder */
  OPT_ftracer = 1113,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1114,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1115,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1116,                   /* -ftrampolines */
  OPT_ftransition_all = 1117,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1118,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1119,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1120,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1121,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1122,              /* -ftransition=field */
  OPT_ftransition_import = 1123,             /* -ftransition=import */
  OPT_ftransition_nogc = 1124,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1125,                /* -ftransition=tls */
  OPT_ftrapping_math = 1126,                 /* -ftrapping-math */
  OPT_ftrapv = 1127,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1128,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1129,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1130,                      /* -ftree-ccp */
  OPT_ftree_ch = 1131,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1132, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1133,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1134,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1135, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1136,                   /* -ftree-cselim */
  OPT_ftree_dce = 1137,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1138,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1139,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1140,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1141,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1142, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1143,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1144,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1145, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1146,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1147,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1148, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1149,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1150,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1151,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1152,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1153,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1154,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1155,                      /* -ftree-pre */
  OPT_ftree_pta = 1156,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1157,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1158, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1159,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1160,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1161,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1162,                     /* -ftree-slsr */
  OPT_ftree_sra = 1163,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1164, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1165, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1166,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1167,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1168,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1169, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1170,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1171, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1172,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1173,         /* -funconstrained-commons */
  OPT_funderscoring = 1174,                  /* -funderscoring */
  OPT_funit_at_a_time = 1175,                /* -funit-at-a-time */
  OPT_funittest = 1176,                      /* -funittest */
  OPT_funroll_all_loops = 1177,              /* -funroll-all-loops */
  OPT_funroll_loops = 1178,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1179, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1180,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1181,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1182,                 /* -funsigned-char */
  OPT_funswitch_loops = 1183,                /* -funswitch-loops */
  OPT_funwind_tables = 1184,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1185,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1186,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1187,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1188,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1189,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1190,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1191,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1192,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1193,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1194,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1195,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1196, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1197,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1198,                   /* -fverbose-asm */
  /* OPT_fversion = 1199, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1200,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1201,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1202,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1203,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1204,                   /* -fvisibility= */
  OPT_fvpt = 1205,                           /* -fvpt */
  OPT_fvtable_gc = 1206,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1207,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1208,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1209,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1210,                     /* -fvtv-debug */
  OPT_fweak = 1211,                          /* -fweak */
  OPT_fweb = 1212,                           /* -fweb */
  /* OPT_fwhole_file = 1213, */              /* -fwhole-file */
  OPT_fwhole_program = 1214,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1215,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1216,             /* -fworking-directory */
  OPT_fwpa = 1217,                           /* -fwpa */
  OPT_fwpa_ = 1218,                          /* -fwpa= */
  OPT_fwrapv = 1219,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1220,                 /* -fwrapv-pointer */
  ...
  OPT_mabi_ = 1277,                          /* -mabi= */
  OPT_mabicalls = 1278,                      /* -mabicalls */
  OPT_mabs_ = 1279,                          /* -mabs= */
  OPT_march_ = 1280,                         /* -march= */
  OPT_mbranch_cost_ = 1281,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1282,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1283,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1284,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1285,             /* -mcompact-branches= */
  OPT_mcrc = 1286,                           /* -mcrc */
  OPT_mdebug = 1287,                         /* -mdebug */
  OPT_mdebugd = 1288,                        /* -mdebugd */
  OPT_mdivide_breaks = 1289,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1290,                  /* -mdivide-traps */
  OPT_mdmx = 1291,                           /* -mdmx */
  OPT_mdouble_float = 1292,                  /* -mdouble-float */
  OPT_mdsp = 1293,                           /* -mdsp */
  OPT_mdspr2 = 1294,                         /* -mdspr2 */
  OPT_meb = 1295,                            /* -meb */
  OPT_mel = 1296,                            /* -mel */
  OPT_membedded_data = 1297,                 /* -membedded-data */
  OPT_meva = 1298,                           /* -meva */
  OPT_mexplicit_relocs = 1299,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1300,                  /* -mextern-sdata */
  OPT_mfix_24k = 1301,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1302,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1303,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1304,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1305,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1306,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1307,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1308,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1309,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1310,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1311,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1312,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1313,                 /* -mfp-exceptions */
  OPT_mfp32 = 1314,                          /* -mfp32 */
  OPT_mfp64 = 1315,                          /* -mfp64 */
  OPT_mfpxx = 1316,                          /* -mfpxx */
  OPT_mframe_header_opt = 1317,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1318, */              /* -mfused-madd */
  OPT_mginv = 1319,                          /* -mginv */
  OPT_mgp32 = 1320,                          /* -mgp32 */
  OPT_mgp64 = 1321,                          /* -mgp64 */
  OPT_mgpopt = 1322,                         /* -mgpopt */
  OPT_mhard_float = 1323,                    /* -mhard-float */
  OPT_mimadd = 1324,                         /* -mimadd */
  OPT_minterlink_compressed = 1325,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1326,              /* -minterlink-mips16 */
  OPT_mips = 1327,                           /* -mips */
  OPT_mips16 = 1328,                         /* -mips16 */
  OPT_mips3d = 1329,                         /* -mips3d */
  OPT_mllsc = 1330,                          /* -mllsc */
  OPT_mload_store_pairs = 1331,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1332,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1333,                    /* -mlong-calls */
  OPT_mlong32 = 1334,                        /* -mlong32 */
  OPT_mlong64 = 1335,                        /* -mlong64 */
  OPT_mloongson_ext = 1336,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1337,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1338,                  /* -mloongson-mmi */
  OPT_mlra = 1339,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1340,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1341,                           /* -mmad */
  OPT_mmadd4 = 1342,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1343,             /* -mmcount-ra-address */
  OPT_mmcu = 1344,                           /* -mmcu */
  OPT_mmemcpy = 1345,                        /* -mmemcpy */
  OPT_mmicromips = 1346,                     /* -mmicromips */
  OPT_mmsa = 1347,                           /* -mmsa */
  OPT_mmt = 1348,                            /* -mmt */
  OPT_mnan_ = 1349,                          /* -mnan= */
  OPT_mno_float = 1350,                      /* -mno-float */
  OPT_mno_flush_func = 1351,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1352,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1353,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1354,                     /* -mno-mips3d */
  OPT_modd_spreg = 1355,                     /* -modd-spreg */
  OPT_mpaired_single = 1356,                 /* -mpaired-single */
  OPT_mplt = 1357,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1358,     /* -mpreferred-stack-boundary= */
  OPT_mr10k_cache_barrier_ = 1359,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1360,               /* -mrelax-pic-calls */
  OPT_mshared = 1361,                        /* -mshared */
  OPT_msingle_float = 1362,                  /* -msingle-float */
  OPT_msmartmips = 1363,                     /* -msmartmips */
  OPT_msoft_float = 1364,                    /* -msoft-float */
  OPT_msplit_addresses = 1365,               /* -msplit-addresses */
  OPT_msym32 = 1366,                         /* -msym32 */
  OPT_msynci = 1367,                         /* -msynci */
  OPT_mtune_ = 1368,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1369,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1370,                          /* -mvirt */
  OPT_mvr4130_align = 1371,                  /* -mvr4130-align */
  OPT_mxgot = 1372,                          /* -mxgot */
  OPT_mxpa = 1373,                           /* -mxpa */
  OPT_n = 1374,                              /* -n */
  OPT_no_canonical_prefixes = 1375,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1376,              /* -no-integrated-cpp */
  OPT_no_pie = 1377,                         /* -no-pie */
  OPT_noasmopt = 1378,                       /* -noasmopt */
  OPT_nocpp = 1379,                          /* -nocpp */
  OPT_nodefaultlibs = 1380,                  /* -nodefaultlibs */
  OPT_nolibc = 1381,                         /* -nolibc */
  OPT_nophoboslib = 1382,                    /* -nophoboslib */
  ...
  OPT_quiet = 1406,                          /* -quiet */
  OPT_r = 1407,                              /* -r */
  OPT_remap = 1408,                          /* -remap */
  OPT_s = 1409,                              /* -s */
  OPT_save_temps = 1410,                     /* -save-temps */
  OPT_save_temps_ = 1411,                    /* -save-temps= */
  OPT_shared = 1412,                         /* -shared */
  OPT_shared_libgcc = 1413,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1414,               /* -shared-libphobos */
  ...
  OPT_static_libphobos = 1425,               /* -static-libphobos */
  ...
  OPT_std_c2x = 1443,                        /* -std=c2x */
  /* OPT_std_c89 = 1444, */                  /* -std=c89 */
  OPT_std_c90 = 1445,                        /* -std=c90 */
  OPT_std_c99 = 1446,                        /* -std=c99 */
  /* OPT_std_c9x = 1447, */                  /* -std=c9x */
  OPT_std_f2003 = 1448,                      /* -std=f2003 */
  OPT_std_f2008 = 1449,                      /* -std=f2008 */
  OPT_std_f2008ts = 1450,                    /* -std=f2008ts */
  OPT_std_f2018 = 1451,                      /* -std=f2018 */
  OPT_std_f95 = 1452,                        /* -std=f95 */
  OPT_std_gnu = 1453,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1454, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1455, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1456,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1457,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1458,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1459, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1460, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1461,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1462,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1463,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1464,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1465, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1466, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1467,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1468, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1469,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1470,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1471, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1472, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1473,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1474, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1475, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1476, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1477, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1478, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1479,                     /* -std=legacy */
  OPT_symbolic = 1480,                       /* -symbolic */
  OPT_t = 1481,                              /* -t */
  OPT_time = 1482,                           /* -time */
  OPT_time_ = 1483,                          /* -time= */
  OPT_traditional = 1484,                    /* -traditional */
  OPT_traditional_cpp = 1485,                /* -traditional-cpp */
  OPT_trigraphs = 1486,                      /* -trigraphs */
  OPT_u = 1487,                              /* -u */
  OPT_undef = 1488,                          /* -undef */
  OPT_v = 1489,                              /* -v */
  OPT_version = 1490,                        /* -version */
  OPT_w = 1491,                              /* -w */
